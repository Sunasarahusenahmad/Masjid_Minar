...
if (isset($_POST['submit'])) {
    ...
    $login_query = "SELECT * FROM `admin_login` WHERE email='$email' && password='$password' ";
...
?>
        <script>
            alert('Please try Again... Enter your valid Email/Password.');
        </script>
<?php
    }
}
